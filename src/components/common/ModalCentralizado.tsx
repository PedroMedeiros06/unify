 ...
 */
export function ModalCentralizado({ visivel, onFechar, children, bloquearFechamentoExterno = false }: Props) {
  ...
  return (
    <Modal visible={montado} transparent animationType="none" onRequestClose={onFechar}>
      <View className="flex-1 items-center justify-center px-5">
        ...
        <Animated.View
          style={{ opacity: progresso, transform: [{ scale: escala }], width: "100%", maxWidth: 400 }}
        >
          <View className="bg-card-background border border-lines-divisions rounded-2xl overflow-hidden max-h-[85vh]">
