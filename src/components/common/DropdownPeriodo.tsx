  ...
  return (
    <DropdownMenu
      ...
      trigger={({ abrir, aberto }) => (
        <Pressable
          onPress={abrir}
          // Sem estado "destaque roxo" por período trocado — o trigger só
          // reage ao menu aberto. Qualquer preset (inclusive "tudo",
          // "hoje" etc.) fica com a borda neutra.
        ...
        >
          <Ionicons name="calendar-outline" color={colors["second-text"]} size={13} />
          <Text
