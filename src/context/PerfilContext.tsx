...
type PerfilContextValue = {
  ...
  carregando: boolean;
  erro: string | null;
  atualizarPerfil: (perfil: PerfilUsuario) => Promise<void>;
};

const PERFIL_VAZIO: PerfilUsuario = { nome: "", email: null };
...
export function PerfilProvider({ children }: { children: ReactNode }) {
  ...
  const atualizarPerfil = useCallback(async (novoPerfil: PerfilUsuario) => {
    try {
